...
XML_ID = "axs_theme._assets_primary_variables"
SCSS_URL = "/axs_theme/static/src/scss/colors.scss"
...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        param.set_param('axs_theme.background_blend_mode', self.theme_background_blend_mode)
        return res
    ...
    def get_values(self):
        ...
        res.update({
            ...
            'theme_background_blend_mode': params.get_param('axs_theme.background_blend_mode', 'normal'),
        })
        return res