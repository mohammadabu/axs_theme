...
odoo.define('axs_theme.AppsMenu', function (require) {
"use strict";
...
var MenuSearchMixin = require("axs_theme.MenuSearchMixin");
...
AppsMenu.include(_.extend({}, MenuSearchMixin, {
    ...
    _setBackgroundImage: function () {
        ...
        if (session.axs_theme_background_blend_mode) {
        	this.$('.o-app-name').css({
        		"mix-blend-mode": session.axs_theme_background_blend_mode,
        	});
        }
    },
